...
This repository contains the completed lab implementation: all eleven nodes, conditional
routing, bounded retries, OpenAI structured output, grounded answers, mock/interrupt HITL,
SQLite checkpoint history, metrics, report generation, and Mermaid graph export.
...
- [x] At least one bonus extension (SQLite persistence and Mermaid graph export)
- [x] Evidence of extension in report and generated output files
